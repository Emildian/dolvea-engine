...
import dovea
from dovea import application, color, curve, shader
from dovea.collider import BoxCollider, CapsuleCollider, Collider, MeshCollider, SphereCollider
from dovea.color import Color
from dovea.mesh import Mesh
from dovea.mesh_importer import load_model
...
from dovea.scripts.every_decorator import every, get_class_name
from dovea.sequence import Func, Sequence, Wait
from dovea.shader import Shader
from dovea.shaders.unlit_shader import unlit_shader
from dovea.shaders.unlit_with_fog_shader import unlit_with_fog_shader
from dovea.string_utilities import print_warning
from dovea.texture import Texture
from dovea.texture_importer import load_texture
from dovea.doveamath import Bounds, lerp
from dovea.doveastuff import Default, PostInitCaller, after
from dovea.vec2 import Vec2
from dovea.vec3 import Vec3
from dovea.vec4 import Vec4

_dovea_instance = None
_warn_if_dovea_not_instantiated = True # gets set to True after dovea.__init__() to ensure the correct order.
...
class Entity(NodePath, metaclass=PostInitCaller):
    ...
    def __init__(self,
        ...
        **kwargs
        ...
        #     if scene.fog_color != dovea.color.clear:
        #         from dovea.shaders.unlit_with_fog_shader import unlit_with_fog_shader
        ...
        if application.trace_entity_definition and add_to_scene_entities or (not _dovea_instance and _warn_if_dovea_not_instantiated and add_to_scene_entities):
            ...
            if caller.code_context:
                ...
                and 'dovea()' not in self.code_context):
        ...
        if not _dovea_instance and _warn_if_dovea_not_instantiated and add_to_scene_entities:
            print_warning('Tried to instantiate Entity before dovea. Please create an instance of dovea first (app = dovea())', self.line_definition)
    ...
    def model_setter(self, value):  # set model with model='model_name' (without file type extension)
        ...
        #     from dovea.shaders.point_shader import point_shader
    ...
    def show_normals_setter(self, value):
        ...
        if value:
            from dovea.shaders import normals_shader
    ...
    def combine(self, analyze=False, auto_destroy=True, ignore:list=None, ignore_disabled=True, include_normals=False):
        from dovea.scripts.combine import combine
...
#------------
    ...
    def blink(self, color=dovea.color.white, shader='unlit_shader', duration=.1, ignore_paused=False):
...
if __name__ == '__main__':
    ...
    # shader test
    from dovea.shaders import lit_with_shadows_shader, matcap_shader
