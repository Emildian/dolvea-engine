...
from dovea import Entity, Vec2, Vec3, color, scene
...
if __name__ == '__main__':
    from dovea import EditorCamera, dovea, Vec3, color
    from dovea.shaders import lit_with_shadows_shader  # you have to apply this shader to enties for them to receive shadows.
