...
from dovea import destroy
from dovea.shaders.text_shader import text_shader
...
class Text(Entity):
    ...
    def background_setter(self, value):
        if value is True:
            ...
            from dovea.doveastuff import destroy
    ...
    def create_background(self, padding=size*2, radius=.1, color=dovea.color.black66, model_class=Quad):
        from dovea import Quad, destroy
...
if __name__ == '__main__':
    from dovea import *
    from dovea import dovea, dedent, window
    app = dovea()
    # Text.size = .001
    descr = dedent('''
