...
from dovea import entity
from dovea import shader
from dovea.audio import _audio_manager
...
from dovea.scripts.singleton_decorator import singleton
@singleton
class dovea(ShowBase):
    def __init__(self, title='dovea', icon='textures/dovea.ico', borderless:bool=False, fullscreen:bool=None, size=None, forced_aspect_ratio=None, position=None, vsync=True, editor_ui_enabled:bool=None, window_type='onscreen', development_mode:bool=None, render_mode=None, show_dovea_splash=False, use_ingame_console=False, **kwargs):
        """The main class of dovea. This class is a singleton, so you can only have one instance of it.
        ...
        Keyword Args (optional):
            ...
            show_dovea_splash (bool): Whether the dovea splash should be shown or not.\n
        ...
        """
        entity._warn_if_dovea_not_instantiated = False
        ...
        application.show_dovea_splash = show_dovea_splash
        ...
        if application.window_type != 'none':
            ...
            if use_ingame_console:
                import builtins
                from dovea import Entity, TextField, color
    ...
    def run(self, info=True):
        if application.show_dovea_splash:
            from dovea.prefabs.splash_screen import doveaSplashScreen
            application.dovea_splash = doveaSplashScreen()
        ...
        if info:
            ...
            dovea_version = version('dovea') if 'dovea' in packages_distributions() else 'unknown'
            print(f'dovea version: {dovea_version}')
