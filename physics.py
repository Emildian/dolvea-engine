...
from dovea import scene, time, color
...
from dovea import Vec2, Default
@generate_properties_for_class()
class PhysicsEntity:
...
if __name__ == '__main__':
    from dovea import dovea, Cylinder, Capsule, Cone, Sequence, Func, curve, Wait, EditorCamera
    from dovea.physics import *

    app = dovea(borderless=False)

    from dovea import *
    from dovea.physics import raycast, CapsuleCollider, BoxCollider, MeshCollider
