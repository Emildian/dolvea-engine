...
if __name__ == '__main__':
    from dovea.doveastuff import _test
...
def rotate_around_point_2d(point, origin, deg):
    angle_rad = -deg/180 * pi # dovea rotation is positive=clockwise, so do *= -1
...
def world_position_to_screen_position(point): # get screen position(ui space) from world space.
    from dovea import camera, Entity, destroy
