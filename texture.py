...
from dovea.doveamath import clamp
from dovea.array_tools import Array2D, enumerate_2d
...
if __name__ == '__main__':
    from dovea import *
    from dovea import texture_importer
    app = dovea()
    '''
    ...
    # from dovea.prefabs.memory_counter import MemoryCounter
    # MemoryCounter()
    def input(key):
        if key == 'a':
