...
from dovea import application, color, entity
...
class Camera(Entity):
    def __init__(self, shader=None, **kwargs):
        original_warn_if_dovea_not_instantiated = entity._warn_if_dovea_not_instantiated
        entity._warn_if_dovea_not_instantiated = False
        super().__init__(shader=shader, **kwargs)
        entity._warn_if_dovea_not_instantiated = original_warn_if_dovea_not_instantiated
...
if __name__ == '__main__':
    from dovea import *
    from dovea import EditorCamera, Entity, dovea, camera
    ...
    from dovea.shaders import camera_grayscale_shader
