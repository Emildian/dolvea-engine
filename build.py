...
from dovea.cmd_tool_maker import auto_log_method_calls, auto_validate_input, make_command_line_app
...
class doveaBuild:
    ...
    # import subprocess
    # import importlib
    # spec = importlib.util.find_spec('dovea')
    # dovea_path = Path(spec.origin).parent
    # subprocess.call([
    #     f'{dovea_path}\\scripts\\_bat_to_exe.bat',
...
if __name__ == '__main__':
    make_command_line_app(doveaBuild)
